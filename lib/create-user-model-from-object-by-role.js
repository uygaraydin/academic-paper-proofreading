...
function createUserModelFromObjectByRole({ id, name, surname, email, phone, department, title, identificationNumber, institutionalNumber, documents = [], role }) {
...
module.exports = createUserModelFromObjectByRole